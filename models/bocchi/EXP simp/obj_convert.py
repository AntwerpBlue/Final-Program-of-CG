...
r += dispatch_material("blue.obj.mdl", parse_obj("blue.obj"), 1,
                  False, True, False, False, 0, 1, 0, [0, 0, 0.8], 0, 1)
...
# bocchi
r+=dispatch_material("b_black.obj.mdl", parse_obj("b_black.obj"), 1,
                  False, False, True, False, 0, 0, 1, [0.01, 0.01, 0.01], 0, 1.3)
r+=dispatch_material("b_pink.obj.mdl", parse_obj("b_pink.obj"), 1,
                  False, False, True, False, 0, 0, 1, [236/255, 164/255, 184/255], 0, 1.3)
r+=dispatch_material("b_blue.obj.mdl", parse_obj("b_blue.obj"), 1,
                  False, False, True, False, 0, 0, 1, [118/255, 195/255, 225/255], 0, 1.3)
r+=dispatch_material("b_yellow.obj.mdl", parse_obj("b_yellow.obj"), 1,
                  False, False, True, False, 0, 0, 1, [224/255, 202/255, 90/255], 0, 1.3)




with open("bocchi.models", "w") as f:
    f.writelines(r)
